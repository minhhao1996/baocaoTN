...
<section id="content">
    <div class="container">
        ...
        <div class="list-product">
            <div class="list-header-z">
                <h2><a href="dien-thoai" style="color: #ff9800">SẢN PHẨM HOT</a></h2>
            </div>
            <div class="list-product-content">
                <?php foreach ($product_buy as $row): ?>
                    <div class="col-xs-6 col-sm-4 col-md-2 col-lg-2 product-one">
                        ...
                        <div class="btn-action">
                            <a href="<?php echo base_url('cart/add/'.$row->id)?>" class="fa fa-shopping-cart"></a>
        ...
        <?php foreach ($catalog_list as $row): ?>
            <div class="list-product">
                <div class="list-header-z">
                    <h2><a href="dien-thoai" style="color: #ff9800"><?php echo $row->name ?></a></h2>
